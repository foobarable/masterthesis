...
A large k should be chosen for very deeply, nested GUI models whereas for flat GUI models a smaller k seems better. At last this parameter has to be evaluated and adjusted to the given input data. 
