...
Figure \ref{fig:mixedtasktree} shows a task tree that constists of two different interactions: A login and an account create procedure.
...
The input of the email address is a text input field of the page where users can create a new account while the login button allows to enter the personal area 
after the entering the users credentials. It is not correct to merge both tasks into one task trees.  
