...
\newenvironment{rules}[1][]{%
  ...
  \definecolor{shaderulecolor}{rgb}{0.0,0.0,0.4}%
  \setlength{\shadeboxrule}{1.5pt}%
  \begin{rles}\hspace*{1mm}%
}{\end{rles}}

\begin{document}

\Number{2014-01} % enter here the actual year and number of your thesis.
\Title{Improving Automatic Task Tree \mbox{Generation} With Alignment Algorithms}
...
\chapter{Approach}
\label{chap:approach}
\input{./chapters/approach/approach}
...
\input{./chapters/casestudy/casestudy}
