...
%TODO: Schoen! Braucht man es ueberhaupt?
%\begin{algorithm}[h]
%\floatname{algorithm}{Algorithm}
%\begin{algorithmic}
...
%		 	\If{EventTaskInstance $\in$ Unique} 
%				\State{SetTask(EventTaskInstance) $\gets$ GetTask(Unique(EventTaskInstance))} 
%			\Else 
%				\State{Unique $\gets$ Unique + EventTaskInstance} 
%			\EndIf
%		 \EndFor
%	 \EndFor
%	\EndProcedure
