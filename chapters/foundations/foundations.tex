...
Harms et al.\cite{harms2013} has created a set of definitions and the respective vocabulary that help dealing with tasktrees.
I will adopt his definitions and summarize them in this section.
To understand tasks and tasktrees we have to look at how users interact with software. 
Perfoming actions like clicking or typing, they trigger so called events. 
	Those events have a type and a target.
